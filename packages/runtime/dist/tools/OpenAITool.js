...
exports.OpenAITool = void 0;
const BaseTool_1 = require("./BaseTool");
const axios_1 = __importDefault(require("axios"));
class OpenAITool extends BaseTool_1.BaseTool {
    constructor() {
        super({
            name: 'openai',
    ...
    async execute(params) {
        const { operation, apiKey, model = 'gpt-3.5-turbo', messages, prompt, temperature = 0.7, maxTokens = 1000, text } = params;
        try {
            const headers = {
            ...
            switch (operation) {
                case 'chat':
                    ...
                    const chatResponse = await axios_1.default.post('https://api.openai.com/v1/chat/completions', {
                        model,
                        messages,
                        temperature,
                ...
                case 'completion':
                    ...
                    const completionResponse = await axios_1.default.post('https://api.openai.com/v1/completions', {
                ...
                case 'image':
                    ...
                    const imageResponse = await axios_1.default.post('https://api.openai.com/v1/images/generations', {
                        prompt,
                        n: 1,
                        size: '1024x1024'
                    }, { headers });
